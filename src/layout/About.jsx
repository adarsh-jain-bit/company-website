...
const About = () => {
  return (
    <section className=" text-white p-8 rounded-lg max-w-7xl mx-auto flex flex-col md:flex-row  gap-8">
    <div className="w-full md:w-1/2 overflow-hidden rounded-lg">
      <img 
        src="/public/about4.jpg" 
        alt="Teamwork Image" 
        className="w-full  rounded-lg h-[540px] object-cover transition-transform duration-500 transform hover:scale-105"
      />
    </div>
    <div className="w-full md:w-1/2 flex flex-col justify-center">
    <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-purple-400 via-blue-500 to-green-400 text-transparent bg-clip-text">
  Welcome to Scale Us, where creativity meets expertise.
</h1>

      <h2 className="text-lg md:text-xl font-semibold mt-4 text-gray-200">
      ...
      <a href="#" className="mt-6 flex items-center gap-2 text-white font-semibold px-5 py-3 rounded-lg cursor-pointer">
